...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST["download_file_by_id"])) {
        $activeTab = "download";
    } elseif (isset($_FILES["bestand"])) {
        $activeTab = "upload";
    }
} elseif (isset($_GET["tab"])) {
    $tab = $_GET["tab"];
    if (in_array($tab, ["upload", "download", "history"])) {
        $activeTab = $tab;
    }
}
...
// Download bestand via file_id en Wachtwoord verwerken
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["download_file_by_id"])) {
    $downloadId = trim($_POST["download_file_id"] ?? '');
    $downloadPassword = $_POST["download_password"] ?? '';
    
    if (empty($downloadId) || empty($downloadPassword)) {
    ...
    elseif ($file["error"] === UPLOAD_ERR_OK) {
        ...
        switch ($file["error"]) {
            ...
            case UPLOAD_ERR_FORM_SIZE:
                ...
                $melding = "Het geüploade bestand is te groot. De maximale bestandsgrootte is {$maxMB} MB.";
                break;
...
<head>
    ...
    <link rel="stylesheet" href="../client/style.css?v=2">
</head>
<body>
    ...
    <div class="layout-wrapper">
        ...
        <aside class="sidebar">
            <div class="sidebar__brand">
                <svg class="sidebar__logo-icon" xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
            ...
            <nav class="sidebar__nav">
                <button type="button" class="sidebar__nav-item <?php echo $activeTab === 'upload' ? 'active' : ''; ?>" data-tab="upload">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="17 8 12 3 7 8"></polyline><line x1="12" y1="3" x2="12" y2="15"></line></svg>
                    <span>Secure Upload</span>
                </button>
                <button type="button" class="sidebar__nav-item <?php echo $activeTab === 'download' ? 'active' : ''; ?>" data-tab="download">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="7 10 12 15 17 10"></polyline><line x1="12" y1="15" x2="12" y2="3"></line></svg>
                    <span>Secure Download</span>
                </button>
                <button type="button" class="sidebar__nav-item <?php echo $activeTab === 'history' ? 'active' : ''; ?>" data-tab="history">
            ...
            <div class="sidebar__footer">
                <div class="sidebar__user-info">
                    <div class="sidebar__user-email" title="<?php echo htmlspecialchars($_SESSION["email"]); ?>">
                ...
                <div class="sidebar__actions">
                    <?php if (isset($_SESSION['role']) && $_SESSION['role'] === 'admin'): ?>
                        <a href="admin.php" class="btn btn--admin-panel btn--sidebar">⚙ Admin Panel</a>
                    <?php endif; ?>
                    <a href="../client/index.php?action=logout" class="btn btn--logout btn--sidebar">Sign Out</a>
                </div>
            </div>
        </aside>
        ...
        <main class="main-content">
            ...
            <header class="topbar">
                <div class="topbar__brand">
                    <button class="sidebar-toggle" id="sidebarToggle" aria-label="Open Navigation Menu">
                    ...
                    <div class="topbar__logo">
                        <svg class="topbar__logo-icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
                            <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path>
                            <polyline points="17 8 12 3 7 8"></polyline>
                            <line x1="12" y1="3" x2="12" y2="15"></line>
                        </svg>
                ...
                <div class="topbar__user">
                    <span><strong><?php echo htmlspecialchars($_SESSION["email"]); ?></strong></span>
                    <a href="../client/index.php?action=logout" class="btn btn--logout btn--compact">Sign Out</a>
                </div>
            </header>

            <div class="content-wrapper">
                <!-- User Alerts (Success / File Upload Errors) -->
                <?php if ($melding): ?>
                ...
                <!-- User Alerts (Download Error Message) -->
                ...
                <!-- Tab Content: Secure Upload -->
                <div class="tab-content <?php echo $activeTab === 'upload' ? 'active' : ''; ?>" id="tab-upload">
                    <section class="upload-section">
                        ...
                        <form action="voorpagina.php?tab=upload" method="POST" enctype="multipart/form-data" class="upload-form">
                ...
                <!-- Tab Content: Secure Download -->
                <div class="tab-content <?php echo $activeTab === 'download' ? 'active' : ''; ?>" id="tab-download">
                    <section class="upload-section">
                        <h2>
                        ...
                        <form action="voorpagina.php?tab=download" method="POST" class="download-form">
                            <div class="form-group">
                                <label for="download_file_id" class="form-label">Asset File ID</label>
                                <input type="text" name="download_file_id" id="download_file_id" required placeholder="e.g. 47291" maxlength="5" class="form-control">
                            </div>
