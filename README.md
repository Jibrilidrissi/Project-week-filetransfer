...
Om het systeem te testen kan je een bestand uploaden, bijvoorbeeld een pdf, png, jpg, zip of txt bestand. Daarna verschijnt het bestand in de lijst met beschikbare bestanden. Via de downloadknop kan het bestand weer worden gedownload.

Als een bestandstype niet is toegestaan of het bestand te groot is, krijgt de gebruiker een foutmelding.
